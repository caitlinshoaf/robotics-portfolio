...
placeholder content — `Caitlin Shoaf`, a generic hero image, and so on.
...
> Replace every "Caitlin Shoaf" placeholder in this site with my name,
...
- [ ] Your name, replacing `Caitlin Shoaf` everywhere it appears.
